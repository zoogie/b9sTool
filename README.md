...
- Never use this on anything but 3DS FIRM 11.4.X-YZ - 11.7.X-YZ.<br>
...
make FIRM_INFO="11.7 only" or whatever is actually the firmware range of the current native firm.
