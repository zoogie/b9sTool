...
- Never use this on anything but 3DS FIRM 11.10.0-YZ.<br>
...
Firmware info:<br>
- 4.0.1 - 5.0.1 is for firmware 11.10 ONLY (always check the firmware in the app menu to be sure as this can change as new firmwares are released!)<br>
